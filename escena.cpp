...
void Escena::visualizarGL( )
{
   ...
   //comprobamos el modo de visualizacion de la aplicacion
...
Escena2::Escena2()
{
   ...
   objetos.push_back(new MallaRevolPLY("peon.ply",300));
   objetos.push_back(new Cilindro(4,50));
   objetos.push_back(new Cono(10,100));
   objetos.push_back(new Esfera(8,50));
   objetos.push_back(new PiramideEstrellaZ(6));
   objetos.push_back(new RejillaY(6,4));
...
Escena3::Escena3(){
   using namespace std;
   cout << "Creando objeto de la práctica 3." << endl ;
   objetos.push_back(new Robot(0,0.5,0));
   objetos.push_back(new GrafoEstrellaX(6,0));
   objetos.push_back(new GrafoCubos(0));
